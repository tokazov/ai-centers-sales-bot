...
- AI Ассистент: Starter $149 + $19/мес (1 бот), Pro $299 + $49/мес (3 бота), Business $499 + $79/мес (10 ботов)
- Computer Use: активация $249 (разово) + от $39/мес (Start), $99/мес (Growth), $299/мес (Scale)

ЕСЛИ НЕ ЗНАЕШЬ ОТВЕТА — скажи "уточню у команды" и попроси контакт.
